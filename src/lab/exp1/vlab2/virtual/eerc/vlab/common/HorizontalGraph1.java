...
public class HorizontalGraph1 extends JPanel implements MouseListener, MouseMotionListener 
{
	...
	public HorizontalGraph1 (int w,int h,String str_x,String str_y) {
	...
	public HorizontalGraph1 (HorizontalGraph graph,int w,int h) {
		   //setBackground(Color.black);
...
//	    }
	    ...
	    if(i<p_secvetx.size())
	    g.fillOval(x, m_y_offset+(int)(p_secvetx.get(i-1)*m_scale_y), 5, 5);

...
//	private javax.swing.JPanel ImagePanel;
	...
	private ChannelsBody       freeBody =null;               // Shape3D
...
//       Appearance app = new Appearance();
	...
	//First state  
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.4f,-0.1f,1.0f),new Vector3d(0.12f,0.04f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/pavo.jpg"));   //box1 horizontal
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.315f,0.04f,1.05f),new Vector3d(0.02f,0.10f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/pavo.jpg"));   //box vertical1
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.485f,0.04f,0.95f),new Vector3d(0.02f,0.10f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/pavo.jpg"));   //box vertical2
	  ...
	  //  obj3.addChild(m_j3d.createBox(new Vector3d(-0.15f,-0.1f,0.8f),new Vector3d(0.5f,0.04f,0.01f), new Vector3d(0, -30, 0), m_j3d.getColor3f(153, 204, 204), "resources/images/steel0001.jpg"));   //bottom box
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.207f,-0.1f,0.157f),new Vector3d(0.01f,0.04f,1.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 153, 204), "resources/images/pavo.jpg"));   //orange box1
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.02f,-0.1f,0.05f),new Vector3d(0.01f,0.04f,1.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 153, 204), "resources/images/pavo.jpg"));   //orange box2
	    
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.6f,-0.1f,-0.75f),new Vector3d(0.12f,0.04f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/pavo.jpg"));   //orange box3
	   ...
	   obj3.addChild(createBox(new Vector3d(-0.203f,0.04f,0.157f),new Vector3d(0.005f,0.025f,0.250f), new Vector3d(0, 30, 0), m_j3d.getColor3f(102, 102, 102)));   //transparent above orange box1
	    ...
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.115f,-0.15f,0.1f),new Vector3d(0.12f,0.01f,1.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 153), "resources/images/orange3.jpg"));   //box1 horizontal
	   ...
	   obj3.addChild(m_j3d.createText2D("Sluice gate & Hydraulic jump notches",new Vector3d(-.97,.54, -0.7),new Vector3d(0.5,0.45,0.4),new Color3f(0f,0f, 0f),20,Font.BOLD ));
	   ...
	   // obj3.addChild(m_j3d.createBox(new Vector3d(0.347f,0.07f,1.030f),new Vector3d(0.03f,0.043f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(51, 204, 51), "resources/images/pavo.jpg"));   //Rectangular neckline center
	    ...
	    obj3.addChild(m_j3d.createBox(new Vector3d(-1.1f,0.40f,-0.9f),new Vector3d(0.078f,0.043f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline
	    obj3.addChild(m_j3d.createBox(new Vector3d(-1.1f,0.4870f,-0.9f),new Vector3d(0.078f,0.045f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline
		
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.9f,0.40f,-0.9f),new Vector3d(0.078f,0.043f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline center
		obj3.addChild(m_j3d.createBox(new Vector3d(-0.946f,0.469f,-0.9f),new Vector3d(0.03f,0.043f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline center
		obj3.addChild(m_j3d.createBox(new Vector3d(-0.855f,0.469f,-0.9f),new Vector3d(0.03f,0.043f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline center
		
		obj3.addChild(m_j3d.createBox(new Vector3d(0.01f,0.12f,0.28f),new Vector3d(0.10f,0.005f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/pavo.jpg"));   //rod
	   ...
	   obj3.addChild(m_j3d.createCylinder(new Vector3d(0.40,0.15f,1.0),new Vector3d(0.02f, 1.0f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0))); // long thin black cylinder
	   obj3.addChild(m_j3d.createCylinder(new Vector3d(0.40,0.20f,1.0),new Vector3d(0.09f, 0.05f, 0.09f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0))); // long thin black cylinder
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.4f,0.020f,1.0f),new Vector3d(0.078f,0.083f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline
	    obj3.addChild(m_j3d.createBox(new Vector3d(1.0f,0.55f,-1.0f),new Vector3d(0.078f,0.083f,0.005f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/watch21.jpg"));   //Rectangular neckline
	    ...
	    //second state
	      ...
	      obj1.addChild(m_j3d.createBox(new Vector3d(0.4f,-0.1f,1.0f),new Vector3d(0.12f,0.04f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/pavo.jpg"));   //box1 horizontal
	    obj1.addChild(m_j3d.createBox(new Vector3d(0.315f,0.04f,1.05f),new Vector3d(0.02f,0.10f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/pavo.jpg"));   //box vertical1
	    obj1.addChild(m_j3d.createBox(new Vector3d(0.485f,0.04f,0.95f),new Vector3d(0.02f,0.10f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/pavo.jpg"));   //box vertical2
        	
	  //  obj1.addChild(m_j3d.createBox(new Vector3d(-0.15f,-0.1f,0.8f),new Vector3d(0.5f,0.04f,0.01f), new Vector3d(0, -30, 0), m_j3d.getColor3f(153, 204, 204), "resources/images/steel0001.jpg"));   //bottom box
	    obj1.addChild(m_j3d.createBox(new Vector3d(-0.207f,-0.1f,0.157f),new Vector3d(0.01f,0.04f,1.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 153, 204), "resources/images/pavo.jpg"));   //orange box1
	    obj1.addChild(m_j3d.createBox(new Vector3d(-0.02f,-0.1f,0.05f),new Vector3d(0.01f,0.04f,1.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 153, 204), "resources/images/pavo.jpg"));   //orange box2
	    
	    obj1.addChild(m_j3d.createBox(new Vector3d(-0.6f,-0.1f,-0.75f),new Vector3d(0.12f,0.04f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/pavo.jpg"));   //orange box3
	   ...
	   obj1.addChild(createBox(new Vector3d(-0.203f,0.04f,0.157f),new Vector3d(0.005f,0.025f,0.250f), new Vector3d(0, 30, 0), m_j3d.getColor3f(102, 102, 102)));   //transparent above orange box1
	    ...
	    obj1.addChild(m_j3d.createBox(new Vector3d(-0.115f,-0.15f,0.1f),new Vector3d(0.12f,0.01f,1.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 153), "resources/images/orange3.jpg"));   //box1 horizontal
	   ...
	   // obj1.addChild(m_j3d.loadObjectFile("resources/geometry/Mycontainer.obj",new Vector3d(0.5f,-0.35f,1.2f),new Vector3d(0.4,.10,0.4),new Vector3d(180,0,0), new Color3f(51, 51, 256)));//hammer
	   ...
	   obj1.addChild(m_j3d.createText2D("Sluice gate & Hydraulic jump notches",new Vector3d(-.97,.54, -0.7),new Vector3d(0.5,0.45,0.4),new Color3f(0f,0f, 0f),20,Font.BOLD ));
	   ...
	   // obj1.addChild(m_j3d.createBox(new Vector3d(0.417f,0.0725f,0.990f),new Vector3d(0.06f,0.045f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(51, 204, 51), "resources/images/pavo.jpg"));   //Rectangular neckline
	    ...
	    obj1.addChild(m_j3d.createBox(new Vector3d(0.4f,-0.016f,1.0f),new Vector3d(0.078f,0.043f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline center
	    obj1.addChild(m_j3d.createBox(new Vector3d(0.446f,0.07f,0.972f),new Vector3d(0.03f,0.043f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline center
	    obj1.addChild(m_j3d.createBox(new Vector3d(0.347f,0.07f,1.030f),new Vector3d(0.03f,0.043f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline center
	    
	  
	    obj1.addChild(m_j3d.createBox(new Vector3d(-1.1f,0.40f,-0.9f),new Vector3d(0.078f,0.043f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline
	    obj1.addChild(m_j3d.createBox(new Vector3d(-1.1f,0.4870f,-0.9f),new Vector3d(0.078f,0.045f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline
		
	    // obj1.addChild(m_j3d.createBox(new Vector3d(-0.9f,0.40f,-0.9f),new Vector3d(0.078f,0.043f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline center
	    //obj1.addChild(m_j3d.createBox(new Vector3d(-0.946f,0.469f,-0.9f),new Vector3d(0.03f,0.043f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline center
	    //obj1.addChild(m_j3d.createBox(new Vector3d(-0.855f,0.469f,-0.9f),new Vector3d(0.03f,0.043f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline center
		
		obj1.addChild(m_j3d.createBox(new Vector3d(0.01f,0.12f,0.28f),new Vector3d(0.10f,0.005f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/pavo.jpg"));   //rod
	   ...
	   obj1.addChild(m_j3d.createCylinder(new Vector3d(0.40,0.43f,1.0),new Vector3d(0.02f, 1.0f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0))); // long thin black cylinder
	   obj1.addChild(m_j3d.createCylinder(new Vector3d(0.40,0.48f,1.0),new Vector3d(0.09f, 0.05f, 0.09f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0))); // long thin black cylinder
	    obj1.addChild(m_j3d.createBox(new Vector3d(0.4f,0.30f,1.0f),new Vector3d(0.078f,0.083f,0.01f), new Vector3d(0, 30, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/orange3.jpg"));   //Rectangular neckline
	    obj1.addChild(m_j3d.createBox(new Vector3d(1.0f,0.55f,-1.0f),new Vector3d(0.078f,0.083f,0.005f), new Vector3d(0, 0, 0), m_j3d.getColor3f(204, 204, 204), "resources/images/watch21.jpg"));   //Rectangular neckline
	
	    obj1.addChild(createCylinder(new Vector3d(0.56,-0.42f,1.0),new Vector3d(1.6f, 1.50f, 1.6f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 102))); //transparent cylinder
	     
	    obj1.addChild(m_j3d.createText2D("Sluice Gate",new Vector3d(.56,.1, 0.8),new Vector3d(0.5,0.45,0.4),new Color3f(0f,0f, 0f),20,Font.BOLD ));
...
/**
   ...
   */
  public Channels(Container container) {
  ...
  private static class MyFrame extends JFrame {
      /**
		...
		MyFrame() {
          ...
          setTitle("Channels Test Applet");
          getContentPane().add(new Channels(this), BorderLayout.CENTER);
          pack();
      }
  }
 ...
 */    
  ...
  private void centerPanel(Container container){
       ...
       JLabel lbl = new JLabel("Channels Test", JLabel.CENTER);

...
public class Sheartest extends javax.swing.JPanel {
	/**
	 * 
	 */
...
//	private javax.swing.JPanel ImagePanel;
	...
	private SheartestBody       freeBody =null;               // Shape3D
...
//		 Floor
   ...
   */
  public Sheartest(Container container) {
  ...
  private static class MyFrame extends JFrame {
      /**
		...
		MyFrame() {
          ...
          setTitle("Shear Test Applet");
          getContentPane().add(new Sheartest(this), BorderLayout.CENTER);
          pack();
      }
  }
...
//
  ...
  private void centerPanel(Container container){
       ...
       JLabel lbl = new JLabel("Shear Test", JLabel.CENTER);

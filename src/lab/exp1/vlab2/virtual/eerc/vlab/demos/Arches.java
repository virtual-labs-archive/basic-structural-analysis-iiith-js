...
public class Arches extends javax.swing.JPanel {
	/**
	 * 
	 */
...
//	private javax.swing.JPanel ImagePanel;
	...
	private ArchesBody       freeBody =null;               // Shape3D
...
//       Appearance app = new Appearance();
	...
	//	cylinder.setCapability(TransformGroup.ALLOW_TRANSFORM_READ);
      ...
      objroot.addChild(objtrans);
	    ...
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.40f,-0.5f,0.1f),new Vector3d(0.02f,0.01f,0.15f), new Vector3d(0, 0, 0), m_j3d.getColor3f(102, 51, 51), "resources/images/silvi.JPG")); // bottom box1
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.40f,-0.5f,0.1f),new Vector3d(0.02f,0.01f,0.15f), new Vector3d(0, 0, 0), m_j3d.getColor3f(102, 51, 51), "resources/images/silvi.JPG")); // bottom box2
		 
	    
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.40f,-0.337f,0.19f),new Vector3d(0.015f,0.15f,0.015f), new Vector3d(0.0f,0.0f,0.0f), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); //box2 left
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.40f,-0.337f,0.19f),new Vector3d(0.015f,0.15f,0.015f), new Vector3d(0.0f,0.0f,0.0f), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); //box2 right
	    
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.40f,-0.337f,0.02f),new Vector3d(0.015f,0.15f,0.015f), new Vector3d(0.0f,0.0f,0.0f), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); //box2 left z
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.40f,-0.337f,0.02f),new Vector3d(0.015f,0.15f,0.015f), new Vector3d(0.0f,0.0f,0.0f), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); //box2 right z
	    
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.40f,-0.2f,0.11f),new Vector3d(0.015f,0.015f,0.07f), new Vector3d(0, 0, 0), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); // connector box2 left
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.40f,-0.2f,0.11f),new Vector3d(0.015f,0.015f,0.07f), new Vector3d(0, 0, 0), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); // connector box2 right
	    
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.0f,-0.18f,0.1f),new Vector3d(0.40f,0.01f,0.04f), new Vector3d(0, 0, 0), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); // lengthy box3
		
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.38f,0.02f,0.1f),new Vector3d(0.2f,0.01f,0.04f), new Vector3d(0, 0, 90), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); // box3 vertical left
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.38f,0.02f,0.1f),new Vector3d(0.2f,0.01f,0.04f), new Vector3d(0, 0, 90), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); // box3 vertical right
		
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.0f,-0.35f,0.19f),new Vector3d(0.39f,0.015f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); // lengthy box4 connector
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.0f,-0.35f,0.02f),new Vector3d(0.39f,0.015f,0.01f), new Vector3d(0, 0, 0), m_j3d.getColor3f(256, 256, 256), "resources/images/silvi.JPG")); // lengthy box4 connector
		
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.0f,0.13f,0.1f),new Vector3d(0.37f,0.05f,0.04f), new Vector3d(0, 0, 0), m_j3d.getColor3f(102, 51, 51), "resources/images/silvi.JPG")); // lengthy box5
	    
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.0,-0.04f,0.1),new Vector3d(0.03f, 1.4f, 0.05f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.0,0.040f,0.1),new Vector3d(0.06f, 0.2f, 0.06f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.0,-0.11f,0.1),new Vector3d(0.22f, 0.05f, 0.22f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
		
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.15,-0.045f,0.1),new Vector3d(0.03f, 1.4f, 0.05f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.15,0.035f,0.1),new Vector3d(0.06f, 0.2f, 0.06f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.15,-0.115f,0.1),new Vector3d(0.22f, 0.05f, 0.22f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
		
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.15,-0.045f,0.1),new Vector3d(0.03f, 1.4f, 0.05f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.15,0.035f,0.1),new Vector3d(0.06f, 0.2f, 0.06f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.15,-0.115f,0.1),new Vector3d(0.22f, 0.05f, 0.22f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
		
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.3,-0.050f,0.1),new Vector3d(0.03f, 1.4f, 0.05f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.3,0.030f,0.1),new Vector3d(0.06f, 0.2f, 0.06f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.3,-0.120f,0.1),new Vector3d(0.22f, 0.05f, 0.22f),new Vector3d(0, 0, 0), m_j3d.getColor3f(51, 51, 51))); // supporting base cylinder1
...
/**
   ...
   */
  public Arches(Container container) {
  ...
  private static class MyFrame extends JFrame {
      /**
		...
		MyFrame() {
          ...
          setTitle("Arches Applet");
          getContentPane().add(new Arches(this), BorderLayout.CENTER);
          pack();
      }
  }
...
//
  ...
  private void centerPanel(Container container){
       ...
       JLabel lbl = new JLabel("Arches Test", JLabel.CENTER);

...
public class MouthPiece extends javax.swing.JPanel {
	...
	private MouthPieceBody freeBody = null; // Shape3D
...
public Group createQuad(Point3f A , Point3f B , Point3f C , Point3f D, Color3f colr,String texfile) {
	 ...
	 */
	public MouthPiece(Container container) {
	...
	public static class MyApplet extends JApplet {
		MouthPiece mainPanel;

		public void init() {
			setLayout(new BorderLayout());
			mainPanel = new MouthPiece(this);
	...
	private static class MyFrame extends JFrame {
		MyFrame() {
			...
			setTitle("MouthPiece Experiment");
			getContentPane().add(new MouthPiece(this), BorderLayout.CENTER);
			pack();
		}
	}
...
//		ink4Pos.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
	...
	private void centerPanel(Container container) {
		...
		JLabel lbl = new JLabel("MouthPiece Experiment", JLabel.CENTER);

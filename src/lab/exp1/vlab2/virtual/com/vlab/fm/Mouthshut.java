...
public class Mouthshut extends javax.swing.JPanel {
	...
	private MouthshutBody freeBody = null; // Shape3D
...
public Group createQuad(Point3f A , Point3f B , Point3f C , Point3f D, Color3f colr,String texfile) {
	...
	public TransformGroup showWaterFall()
	{
		...
		int i = 0;
		double pos_cylinder_x = 0.1;
		double pos_cylinder_y = 0.13;
		double pos_cylinder_z = 0.020;
	...
	//	trans.setCapability(Group.ALLOW_CHILDREN_EXTEND);
		...
		//if(i <=8)
			trans.addChild(m_j3d.createCylinder(new Vector3d(pos_cylinder_x,pos_cylinder_y,pos_cylinder_z), new Vector3d(0.1,.15,.1),new Vector3d(0,0,90), new Color3f(0,0,1)));
		//else
	...
	private Group createVirtualLab() {
		 ...
		 Transform3D t = new Transform3D();
		    ...
		    //t2.setRotation(new AxisAngle4f(0,1,0,-30*3.14f/180));
		    objtrans_small.addChild(m_j3d.createCylinder(new Vector3d(.12,0.14,0.005), new Vector3d(0.20,2,.15),new Vector3d(0,0,90), new Color3f(.2f,0.7f,0.1f)));
		    ...
		    objtrans.addChild(createQuad(new Point3f(-0.5f,0.28f,0f),new Point3f(-.21f,0.42f,0f),new Point3f(-0.21f,0.35f,0.0f),new Point3f(-0.40f,0.26f,0),new Color3f(.7f,.5f,0f),null));
		    objtrans.addChild(createQuad(new Point3f(-0.21f,0.35f,0.0f),new Point3f(-.21f,0.42f,0f),new Point3f(0.12f,0.35f,0.0f),new Point3f(0.035f,0.30f,0.0f),new Color3f(.7f,.5f,0f),null));
		    ...
		    objtrans.addChild(createQuad(new Point3f(-0.40f,0.26f,0),new Point3f(-0.21f,0.35f,0.0f),new Point3f(0.035f,0.30f,0.0f),new Point3f(-.15f,0.21f,0.0f),new Color3f(0f,0f,1f),null));
		//    objtrans.addChild(m_j3d.createCylinder(new Vector3d(.3,0.14,0.015), new Vector3d(0.20,1.4,.15),new Vector3d(0,0,90), new Color3f(0f,0f,0)));
		    objtrans.addChild(objtrans_small);
		    objtrans.addChild(m_j3d.createCylinder(new Vector3d(.01,0.14,-0.015), new Vector3d(0.10,.4,.15),new Vector3d(60,0,-1), new Color3f(0,0,1)));
		    ...
		    objtrans.addChild(createQuad(new Point3f(-0.07f,-0.12f,0f),new Point3f(0.22f,0.034f,0.0f),new Point3f(.22f,-0.03f,0.0f),new Point3f(0.008f,-0.137f,0.0f),new Color3f(.7f,.5f,0f),null));
		    objtrans.addChild(createQuad(new Point3f(.22f,-0.03f,0.0f),new Point3f(0.22f,0.034f,0.0f),new Point3f(.46f,-0.032f,0.0f),new Point3f(.4f,-0.07f,0.0f),new Color3f(.7f,.5f,0f),null));
		    ...
		    objtrans.addChild(createQuad(new Point3f(0.008f,-0.137f,0.0f),new Point3f(.22f,-0.03f,0.0f),new Point3f(.4f,-0.07f,0.0f),new Point3f(.22f,-0.18f,0.0f),new Color3f(0f,0f,1f),null));
		...
		//    objtrans.addChild(m_j3d.createBox(new Vector3d(.35f,-.2f,.05f),new Vector3d(.06f,.045f,.0006f), new Vector3d(0.0f,0.0f,0.0f),new Color3f(1f,1f,1f),"resources/images/tap2.gif"));
		    ...
		    // water from the tap
		   	ink1Pos.addChild(m_j3d.createCylinder(new Vector3d(-.029,0.007,0.015), new Vector3d(0.13,.4,.15),new Vector3d(0,0,-1), new Color3f(0,0,1)));
	 ...
	 */
	public Mouthshut(Container container) {
	...
	private static class MyFrame extends JFrame {
		MyFrame() {
			...
			setTitle("Mouthshut Experiment");
			getContentPane().add(new Mouthshut(this), BorderLayout.CENTER);
			pack();
		}
	}
...
//		ink4Pos.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
	...
	private void centerPanel(Container container) {
		...
		JLabel lbl = new JLabel("Mouthshut Experiment", JLabel.CENTER);
	...
	//	in2.setBackground(bk);
		...
		lab = new JLabel("Mouthshut Number ", JLabel.RIGHT);

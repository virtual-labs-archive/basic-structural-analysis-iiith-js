...
public class water_content extends javax.swing.JPanel {
...
//	private javax.swing.JButton rightIcon=null;
	...
	private WaterContentBody       freeBody =null;               // Shape3D
...
//		 Floor
  ...
  public Group createWireBox(Vector3d pos,Vector3d scale,Vector3d rot,Color3f colr) {
	...
	private Group createVirtualLab() {	
	 ...
	 // Load and Spring Part :
      ...
      obj2.addChild(m_j3d.createBox(new Vector3d(.25f,-.11,.8),new Vector3d(0.05f, .005f, 0.05f),new Vector3d(2f, 0f,0f), new Color3f(.85f, 0.64f, .125f)));
      obj2.addChild(m_j3d.createText2D("100 C",new Vector3d(-.02,-.02, 2),new Vector3d(0.4,0.4,0.4),new Color3f(1f,1f, 0f),16,Font.BOLD ));
   ...
   */
  public water_content(Container container) {
...
//      scene.addChild(bgleg);
  ...
  public static class MyApplet extends JApplet {
      /**
		...
		water_content mainPanel;

      public void init() {
          setLayout(new BorderLayout());
          mainPanel = new water_content(this);
  ...
  private static class MyFrame extends JFrame {
      /**
		...
		MyFrame() {
          ...
          setTitle("Water Content of Soil Applet");
          getContentPane().add(new water_content(this), BorderLayout.CENTER);
          pack();
      }
  }

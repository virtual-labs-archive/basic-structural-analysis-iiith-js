...
public class SpecificGravity extends javax.swing.JPanel {
...
//		 Floor
	...
	private Group createVirtualLab() {	
	 ...
	 // Load and Spring Part :
        ...
        //vessel
       obj3.addChild(createCylinder(new Vector3d(.001f,.14f,.92f),new Vector3d(1,3.5,1),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(176, 213, 230)));
	  ...
	  //Base(weight)
	    obj3.addChild(createWireBox(new Vector3d(0,-.08f,.8),new Vector3d(0.2f, .03f, 0.2f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(160,82,45)));
	    ...
	    //Sand filled
		  ...
		  //Base(weight)
		    ...
		    //sand
		    obj1.addChild(m_j3d.createCylinder(new Vector3d(.001f,.01f,.92f),new Vector3d(1,.9,1),new Vector3d(0,0,0), m_j3d.getColor3f(139, 69, 19)));
		    ...
		    obj2.addChild(createCylinder(new Vector3d(.001f,.14f,.92f),new Vector3d(1,3.5,1),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(176, 213, 230)));
			  ...
			  //Base(weight)
			    ...
			    //sand
			    obj2.addChild(m_j3d.createCylinder(new Vector3d(.001f,.01f,.92f),new Vector3d(1,.9,1),new Vector3d(0,0,0), m_j3d.getColor3f(139, 69, 19)));
			    ...
			    //water
			    obj2.addChild(createCylinder(new Vector3d(.001f,.13f,.92f),new Vector3d(1,1.5,1),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(65, 105, 240)));
     ...
     */
    public SpecificGravity(Container container) {
...
//        scene.addChild(bgleg);
    ...
    public static class MyApplet extends JApplet {
		...
		SpecificGravity mainPanel;

        public void init() {
            setLayout(new BorderLayout());
            mainPanel = new SpecificGravity(this);
    ...
    private static class MyFrame extends JFrame {
		...
		MyFrame() {
            ...
            getContentPane().add(new SpecificGravity(this), BorderLayout.CENTER);
            pack();
        }
    }
...
//  //      rightBottom.setBackground(new Color(100,200,100));
    ...
    private void centerPanel(Container container){
         ...
         JLabel lbl = new JLabel("Specific Gravity Experiment ", JLabel.CENTER);

...
public class DirectShear extends javax.swing.JPanel {
	/**
	 * 
	 */
...
//	private javax.swing.JPanel ImagePanel;
	...
	private DirectShearBody       freeBody =null;               // Shape3D
...
//		 Floor
  ...
  public Group createWireBox(Vector3d pos,Vector3d scale,Vector3d rot,Color3f colr) {
	...
	private Group createVirtualLab() {	
      ...
      //objroot.addChild(objtrans);
	    ...
	    //First state
	    obj3.addChild(createBox(new Vector3d(0,-0.04f,.2),new Vector3d(0.06f, .015f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));
	    obj3.addChild(createBox(new Vector3d(0,0.08f,.2),new Vector3d(0.06f, .015f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));
	    
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.262,0.10f,.2),new Vector3d(0.02f, .08f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
	    obj3.addChild(m_j3d.createBox(new Vector3d(0.262,-0.05f,.2),new Vector3d(0.02f, .07f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
		
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.262,0.10f,.2),new Vector3d(0.02f, .08f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.262,-0.05f,.2),new Vector3d(0.02f, .07f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
		  
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0,0.175f,0.2),new Vector3d(0.8,0.6f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0,0.215f,0.2),new Vector3d(0.2,0.2f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
		    
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.5,0.2f,-0.35),new Vector3d(1.3,1.8f,0.3),new Vector3d(0,0,0),new Color3f(0.4f,0.0f,0.0f)));
	    obj3.addChild(m_j3d.createText2D("Soil",new Vector3d(.45,0.21, -0.3),new Vector3d(0.4,0.4,0.4),new Color3f(1f,1f, 1f),24,Font.BOLD )); 
	    
	    
	    obj3.addChild(m_j3d.createBox(new Vector3d(-0.462,0.30f,.2),new Vector3d(0.05f, .05f, 0.02f),new Vector3d(2f, 0f,0f), new Color3f(1.0f,1.0f,1.0f),"resources/images/guage1.jpg"));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.35,-0.1f,0.2),new Vector3d(0.07,2.1f,0.3),new Vector3d(0,0,90),new Color3f(0f,0f,0f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.45,0.07f,0.2),new Vector3d(0.07,3.5f,0.3),new Vector3d(0,0,0),new Color3f(0f,0f,0f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.26,0.23f,0.2),new Vector3d(0.07,1.2f,0.3),new Vector3d(0,0,0),new Color3f(0f,0f,0f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.335,0.28f,0.2),new Vector3d(0.07,1.55f,0.3),new Vector3d(0,0,90),new Color3f(0f,0f,0f)));
	    ...
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.330,-0.01f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.30,-0.03f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.330,-0.01f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.30,-0.03f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.330,0.1f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.30,0.12f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	            
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.0,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.1,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.2,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.1,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.2,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.15,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.05,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(-0.15,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj3.addChild(m_j3d.createCylinder(new Vector3d(0.05,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	          
	    //cyl1.addChild(m_j3d.createCylinder(new Vector3d(-0.35,-0.35f,0.35),new Vector3d(0.3,3.0f,0.3),new Vector3d(0,0,0),new Color3f(0.4f,0.2f,0.0f)));
	    
	  
	    //obj3.addChild(m_j3d.createCylinder(new Vector3d(0,0,0.3),new Vector3d(0.3,0.3f,0.3),new Vector3d(0,6f,0),new Color3f(0.4f,0.2f,0.0f)));
	 
	    //second state
	    obj1.addChild(createBox(new Vector3d(0,-0.04f,.2),new Vector3d(0.06f, .015f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));
	    obj1.addChild(createBox(new Vector3d(0,0.08f,.2),new Vector3d(0.06f, .015f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));
	    
	    obj1.addChild(m_j3d.createBox(new Vector3d(0.262,0.10f,.2),new Vector3d(0.02f, .08f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
	    obj1.addChild(m_j3d.createBox(new Vector3d(0.262,-0.05f,.2),new Vector3d(0.02f, .07f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
		
	    obj1.addChild(m_j3d.createBox(new Vector3d(-0.262,0.10f,.2),new Vector3d(0.02f, .08f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
	    obj1.addChild(m_j3d.createBox(new Vector3d(-0.262,-0.05f,.2),new Vector3d(0.02f, .07f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
		  
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0,0.175f,0.2),new Vector3d(0.8,0.6f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0,0.215f,0.2),new Vector3d(0.2,0.2f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
		    
	       
	    obj1.addChild(m_j3d.createBox(new Vector3d(-0.462,0.30f,.2),new Vector3d(0.05f, .05f, 0.02f),new Vector3d(2f, 0f,0f), new Color3f(1.0f,1.0f,1.0f),"resources/images/guage1.jpg"));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.35,-0.1f,0.2),new Vector3d(0.07,2.1f,0.3),new Vector3d(0,0,90),new Color3f(0f,0f,0f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.45,0.07f,0.2),new Vector3d(0.07,3.5f,0.3),new Vector3d(0,0,0),new Color3f(0f,0f,0f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.26,0.23f,0.2),new Vector3d(0.07,1.2f,0.3),new Vector3d(0,0,0),new Color3f(0f,0f,0f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.335,0.28f,0.2),new Vector3d(0.07,1.55f,0.3),new Vector3d(0,0,90),new Color3f(0f,0f,0f)));
		     
	    
	    
	    
	    
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0.330,-0.01f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0.30,-0.03f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.330,-0.01f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.30,-0.03f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.330,0.1f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.30,0.12f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	            
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0.0,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0.1,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0.2,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.1,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.2,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0.15,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.05,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(-0.15,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0.05,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	          
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0,0.06f,0.2),new Vector3d(2.0,0.8f,0.3),new Vector3d(0,0,0),new Color3f(0.4f,0.0f,0.0f)));
	    obj1.addChild(m_j3d.createCylinder(new Vector3d(0,-0.03f,0.2),new Vector3d(2.0,1.0f,0.3),new Vector3d(0,0,0),new Color3f(0.4f,0.0f,0.0f)));
		    
	    
	    //Third state
	    
	    obj2.addChild(createBox(new Vector3d(-0.1,-0.04f,.2),new Vector3d(0.06f, .015f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));
	    obj2.addChild(createBox(new Vector3d(0,0.1f,.2),new Vector3d(0.06f, .015f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));
	    
	    obj2.addChild(m_j3d.createBox(new Vector3d(0.262,0.12f,.2),new Vector3d(0.02f, .08f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
	    obj2.addChild(m_j3d.createBox(new Vector3d(0.162,-0.05f,.2),new Vector3d(0.02f, .07f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
		
	    obj2.addChild(m_j3d.createBox(new Vector3d(-0.262,0.12f,.2),new Vector3d(0.02f, .08f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
	    obj2.addChild(m_j3d.createBox(new Vector3d(-0.362,-0.05f,.2),new Vector3d(0.02f, .07f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
		  
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(0,0.195f,0.2),new Vector3d(0.8,0.6f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(0,0.235f,0.2),new Vector3d(0.2,0.2f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
		  
	    
	    obj2.addChild(m_j3d.createBox(new Vector3d(-0.562,0.30f,.2),new Vector3d(0.05f, .05f, 0.02f),new Vector3d(2f, 0f,0f), new Color3f(1.0f,1.0f,1.0f),"resources/images/guage2.jpg"));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.45,-0.1f,0.2),new Vector3d(0.07,2.1f,0.3),new Vector3d(0,0,90),new Color3f(0f,0f,0f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.55,0.07f,0.2),new Vector3d(0.07,3.5f,0.3),new Vector3d(0,0,0),new Color3f(0f,0f,0f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.26,0.23f,0.2),new Vector3d(0.07,1.2f,0.3),new Vector3d(0,0,0),new Color3f(0f,0f,0f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.39,0.28f,0.2),new Vector3d(0.07,2.44f,0.3),new Vector3d(0,0,90),new Color3f(0f,0f,0f)));
		     
	    
	    
	    
	       
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(0.230,-0.01f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(0.20,-0.03f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.430,-0.01f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.40,-0.03f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.330,0.12f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.30,0.14f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	            
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.1,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(0.0,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(0.1,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.2,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.3,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(0.05,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.15,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.25,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.05,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	          
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(0,0.08f,0.2),new Vector3d(2.0,0.8f,0.3),new Vector3d(0,0,0),new Color3f(0.4f,0.0f,0.0f)));
	    obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.1,-0.03f,0.2),new Vector3d(2.0,1.0f,0.3),new Vector3d(0,0,0),new Color3f(0.4f,0.0f,0.0f)));
		       
	   obj2.addChild(m_j3d.createCylinder(new Vector3d(0.05,0.028f,0.2),new Vector3d(0.10,2.25f,0.3),new Vector3d(0,0,90),new Color3f(0.0f,0.0f,0.0f)));
	   obj2.addChild(m_j3d.createCylinder(new Vector3d(-0.15,0.028f,0.2),new Vector3d(0.10,2.25f,0.3),new Vector3d(0,0,90),new Color3f(0.0f,0.0f,0.0f)));
		    
	    
	   //Fourth State
	   
	   obj4.addChild(createBox(new Vector3d(0,-0.04f,.2),new Vector3d(0.06f, .015f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));
	    obj4.addChild(createBox(new Vector3d(0,0.08f,.2),new Vector3d(0.06f, .015f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));
	    
	    obj4.addChild(m_j3d.createBox(new Vector3d(0.262,0.10f,.2),new Vector3d(0.02f, .08f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
	    obj4.addChild(m_j3d.createBox(new Vector3d(0.262,-0.05f,.2),new Vector3d(0.02f, .07f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
		
	    obj4.addChild(m_j3d.createBox(new Vector3d(-0.262,0.10f,.2),new Vector3d(0.02f, .08f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
	    obj4.addChild(m_j3d.createBox(new Vector3d(-0.262,-0.05f,.2),new Vector3d(0.02f, .07f, 0.15f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
		  
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0,0.175f,0.2),new Vector3d(0.8,0.6f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0,0.215f,0.2),new Vector3d(0.2,0.2f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
		    
	     
	    obj4.addChild(m_j3d.createBox(new Vector3d(-0.462,0.30f,.2),new Vector3d(0.05f, .05f, 0.02f),new Vector3d(2f, 0f,0f), new Color3f(1.0f,1.0f,1.0f),"resources/images/guage1.jpg"));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.35,-0.1f,0.2),new Vector3d(0.07,2.1f,0.3),new Vector3d(0,0,90),new Color3f(0f,0f,0f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.45,0.07f,0.2),new Vector3d(0.07,3.5f,0.3),new Vector3d(0,0,0),new Color3f(0f,0f,0f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.26,0.23f,0.2),new Vector3d(0.07,1.2f,0.3),new Vector3d(0,0,0),new Color3f(0f,0f,0f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.335,0.28f,0.2),new Vector3d(0.07,1.55f,0.3),new Vector3d(0,0,90),new Color3f(0f,0f,0f)));
		      
	    
	    
	    
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0.330,-0.01f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0.30,-0.03f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.330,-0.01f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.30,-0.03f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.330,0.1f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,0),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.30,0.12f,0.2),new Vector3d(0.05,0.5f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	            
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0.0,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0.1,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0.2,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.1,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.2,-0.14f,0.2),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0.15,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.05,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(-0.15,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0.05,-0.14f,-0.1),new Vector3d(0.25,0.25f,0.3),new Vector3d(0,0,90),new Color3f(0.2f,0.2f,0.2f)));
	          
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0,0.06f,0.2),new Vector3d(2.0,0.8f,0.3),new Vector3d(0,0,0),new Color3f(0.4f,0.0f,0.0f)));
	    obj4.addChild(m_j3d.createCylinder(new Vector3d(0,-0.03f,0.2),new Vector3d(2.0,1.0f,0.3),new Vector3d(0,0,0),new Color3f(0.4f,0.0f,0.0f)));
		     
	   // obj1.addChild(createBox(new Vector3d(0,.02f,.3),new Vector3d(0.06f, .04f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));
	    //obj1.addChild(createBox(new Vector3d(0,0.35f,.3),new Vector3d(0.06f, .04f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));

	   //obj1.addChild(m_j3d.loadObjectFile("resources/geometry/verreEau.obj",new Vector3d(0.0f,.25f,1f),new Vector3d(0.3,.3,0.3),new Vector3d(0,0,0), new Color3f(1, 0, 0)));
		 // obj1.addChild(m_j3d.createCylinder(new Vector3d(.001f,.02f,.92f),new Vector3d(1.46,1.8,1),new Vector3d(0,0,0), m_j3d.getColor3f(139, 69, 19)));
		  //obj1.addChild(m_j3d.createCylinder(new Vector3d(.001f,0.05f,.92f),new Vector3d(1.49,.8,1),new Vector3d(0,0,0), m_j3d.getColor3f(162, 82, 45)));

	    
	    
	    // Load and Spring Part :
      //filled
	   // objtrans.addChild(m_j3d.loadObjectFile("resources/geometry/verreEau.obj",new Vector3d(0.0f,.25f,1f),new Vector3d(0.3,.3,0.3),new Vector3d(0,0,0), new Color3f(1, 0, 0)));
	  //  cyl1.addChild(m_j3d.createCylinder(new Vector3d(.001f,.02f,.92f),new Vector3d(1.46,.9,1),new Vector3d(0,0,0), m_j3d.getColor3f(139, 69, 19)));
	  //  cyl2.addChild(m_j3d.createCylinder(new Vector3d(.001f,0.05f,.92f),new Vector3d(1.49,.05,1),new Vector3d(0,0,0), m_j3d.getColor3f(162, 82, 45)));
	       
	  //  objtrans.addChild(m_j3d.createBox(new Vector3d(-.25f,-.11,.8),new Vector3d(0.05f, .005f, 0.05f),new Vector3d(2f, 0f,0f), new Color3f(.85f, 0.64f, .125f)));
    //  objtrans.addChild(m_j3d.createBox(new Vector3d(.25f,-.11,.8),new Vector3d(0.05f, .005f, 0.05f),new Vector3d(2f, 0f,0f), new Color3f(.85f, 0.64f, .125f)));
	// 	objtrans.addChild(cyl1);
	 //   objtrans.addChild(cyl2);
	    //base(weight)
	    //obj3.addChild(createBox(new Vector3d(0,.02f,.3),new Vector3d(0.06f, .04f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(51, 204, 204)));
	   // obj1.addChild(m_j3d.createBox(new Vector3d(0,-.08f,.8),new Vector3d(0.2f, .03f, 0.2f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(188,143,143)));
	   // obj1.addChild(m_j3d.createText2D("700 g",new Vector3d(-.04,-.02, 2),new Vector3d(0.4,0.4,0.4),new Color3f(0f,0f, 0f),20,Font.BOLD ));

	  //  obj1.addChild(objtrans);
	    //in Oven
	//    String str="100 C";
	//    box.addChild(createBox(new Vector3d(0,.1f,.8),new Vector3d(0.05f, .05f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(220, 220, 220)));
	  //  box.addChild(createWireBox(new Vector3d(0,.1f,.8),new Vector3d(0.05f, .05f, 0.05f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(0, 0, 0)));
	 //   obj2.addChild(box);
	  //  obj2.addChild(m_j3d.createBox(new Vector3d(0,-.05f,.8),new Vector3d(0.2f, .01f, 0.2f),new Vector3d(2f, 0f,0f), new Color3f()));
	    
	 //   obj2.addChild(m_j3d.loadObjectFile("resources/geometry/verreEau.obj",new Vector3d(0.0f,.25f,1f),new Vector3d(0.3,.3,0.3),new Vector3d(0,0,0), new Color3f(1, 0, 0)));
	  //  obj2.addChild(m_j3d.createCylinder(new Vector3d(.001f,.02f,.92f),new Vector3d(1.46,.8,1),new Vector3d(0,0,0), m_j3d.getColor3f(139, 69, 19)));
	   // obj2.addChild(m_j3d.createCylinder(new Vector3d(.001f,0.05f,.92f),new Vector3d(1.49,.05,1),new Vector3d(0,0,0), m_j3d.getColor3f(162, 82, 45)));
	       
	 //   obj2.addChild(m_j3d.createBox(new Vector3d(-.25f,-.11,.8),new Vector3d(0.05f, .005f, 0.05f),new Vector3d(2f, 0f,0f), new Color3f(.85f, 0.64f, .125f)));
	  //  obj2.addChild(m_j3d.createBox(new Vector3d(.25f,-.11,.8),new Vector3d(0.05f, .005f, 0.05f),new Vector3d(2f, 0f,0f), new Color3f(.85f, 0.64f, .125f)));
	  //  obj2.addChild(m_j3d.createText2D("100 C",new Vector3d(-.02,.03, 2),new Vector3d(0.4,0.4,0.4),new Color3f(1f,1f, 0f),16,Font.BOLD ));
	    //base(weight)
	//	obj2.addChild(createWireBox(new Vector3d(0,-.08f,.8),new Vector3d(0.2/4f, .03/4f, 0.2/4f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(160,82,45)));
	 //   obj2.addChild(m_j3d.createBox(new Vector3d(0,-.08f,.8),new Vector3d(0.2f, .03f, 0.2f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(188,143,143)));
	  //  obj2.addChild(m_j3d.createText2D("700 g",new Vector3d(-.04,-.02, 2),new Vector3d(0.4,0.4,0.4),new Color3f(0f,0f, 0f),20,Font.BOLD ));

	    //obj2.addChild(obj1);
	    
	    //empty
	    
	 //   obj3.addChild(m_j3d.loadObjectFile("resources/geometry/verreEau.obj",new Vector3d(0.0f,.25f,1f),new Vector3d(0.3,.3,0.3),new Vector3d(0,0,0), new Color3f(1, 0, 0)));
	 //   obj3.addChild(m_j3d.createBox(new Vector3d(-.25f,-.11,.8),new Vector3d(0.05f, .005f, 0.05f),new Vector3d(2f, 0f,0f), new Color3f(.85f, 0.64f, .125f)));
	 //   obj3.addChild(m_j3d.createBox(new Vector3d(.25f,-.11,.8),new Vector3d(0.05f, .005f, 0.05f),new Vector3d(2f, 0f,0f), new Color3f(.85f, 0.64f, .125f)));
	    //base(weight)
	//    obj3.addChild(createWireBox(new Vector3d(0,-.08f,.8),new Vector3d(0.2/4f, .03/4f, 0.2/4f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(160,82,45)));
	//    obj3.addChild(m_j3d.createBox(new Vector3d(0,-.08f,.8),new Vector3d(0.2f, .03f, 0.2f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(188,143,143)));
	//    obj3.addChild(m_j3d.createText2D("700 g",new Vector3d(-.04,-.02, 2),new Vector3d(0.4,0.4,0.4),new Color3f(0f,0f, 0f),20,Font.BOLD ));

	    //filled after oven
	 //   obj4.addChild(m_j3d.loadObjectFile("resources/geometry/verreEau.obj",new Vector3d(0.0f,.25f,1f),new Vector3d(0.3,.3,0.3),new Vector3d(0,0,0), new Color3f(1, 0, 0)));
	 //   obj4.addChild(m_j3d.createCylinder(new Vector3d(.001f,.01f,.92f),new Vector3d(1.46,.5,1),new Vector3d(0,0,0), m_j3d.getColor3f(139, 69, 19)));
	 //   obj4.addChild(m_j3d.createCylinder(new Vector3d(.001f,0.04f,.92f),new Vector3d(1.49,.05,1),new Vector3d(0,0,0), m_j3d.getColor3f(162, 82, 45)));
	    //base(weight) 
	  //  obj4.addChild(createWireBox(new Vector3d(0,-.08f,.8),new Vector3d(0.2/4f, .03/4f, 0.2/4f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(160,82,45)));
	  //  obj4.addChild(m_j3d.createBox(new Vector3d(0,-.08f,.8),new Vector3d(0.2f, .03f, 0.2f),new Vector3d(2f, 0f,0f), m_j3d.getColor3f(188,143,143)));
	  //  obj4.addChild(m_j3d.createText2D("700 g",new Vector3d(-.04,-.02, 2),new Vector3d(0.4,0.4,0.4),new Color3f(0f,0f, 0f),20,Font.BOLD ));

	//  obj4.addChild(m_j3d.createBox(new Vector3d(-.25f,-.11,.8),new Vector3d(0.05f, .005f, 0.05f),new Vector3d(2f, 0f,0f), new Color3f(.85f, 0.64f, .125f)));
    //  obj4.addChild(m_j3d.createBox(new Vector3d(.25f,-.11,.8),new Vector3d(0.05f, .005f, 0.05f),new Vector3d(2f, 0f,0f), new Color3f(.85f, 0.64f, .125f)));
   ...
   */
  public DirectShear(Container container) {
...
//      scene.addChild(bgleg);
  ...
  public static class MyApplet extends JApplet {
      /**
		 ...
		 */
		private static final long serialVersionUID = 1L;
		DirectShear mainPanel;

      public void init() {
          setLayout(new BorderLayout());
          mainPanel = new DirectShear(this);
  ...
  private static class MyFrame extends JFrame {
      /**
		...
		MyFrame() {
          ...
          setTitle("Direct Shear Applet");
          getContentPane().add(new DirectShear(this), BorderLayout.CENTER);
          pack();
      }
  }
...
//      rightBottom.setBackground(new Color(100,200,100));
  ...
  private void rightPanel() {
      ...
      ImageIcon icon = m_j3d.createImageIcon("resources/CA/graphdirect.jpg"); 
...
//
  ...
  private void centerPanel(Container container){
       ...
       JLabel lbl = new JLabel("Direct Shear Test", JLabel.CENTER);
...
//		break;
  ...
  private void setInstructionText()
  {
  	...
  	switch(stage){
  	case 0: // Home 
  		m_Objective.setText("* Observe the compaction");
  		m_Objective.setForeground(Color.WHITE);
  					break;
  	case 1:
  		m_Objective.setText("* Observe the compaction");

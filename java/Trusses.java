...
public class Trusses extends javax.swing.JPanel {
	/**
	 * 
	 */
...
//		 Floor
   ...
   */
  public Trusses(Container container) {
  ...
  private static class MyFrame extends JFrame {
      /**
		...
		MyFrame() {
          ...
          setTitle("Trusses Applet");
          getContentPane().add(new Trusses(this), BorderLayout.CENTER);
          pack();
      }
  }
...
////      rightBottom.setBackground(new Color(100,200,100));
  ...
  private void centerPanel(Container container){
       ...
       JLabel lbl = new JLabel("Trusses ", JLabel.CENTER);
...
//  }
  ...
  public int getStr() {
	...
	private void initInputControlsField() {
		...
		iLabel[i++].setForeground(Color.blue);// new JLabel(":Trusses (Hinge)",
												// JLabel.LEFT);

...
public class Beams_Defelection1 extends javax.swing.JPanel {
	...
	private Switch objSwitchUDL = new Switch();
	...
	private Group createVirtualLab() {
		...
		TransformGroup Ubeam1 = new TransformGroup(t);
		TransformGroup Ubeam2 = new TransformGroup(t);
		TransformGroup Ubeam3 = new TransformGroup(t);
		TransformGroup Ubeam4 = new TransformGroup(t);
		TransformGroup Ubeam5 = new TransformGroup(t);
		TransformGroup Ubeam6 = new TransformGroup(t);
		
		
		TransformGroup ptArr1 = new TransformGroup(t);
		TransformGroup ptArr2 = new TransformGroup(t);
		TransformGroup ptArr3 = new TransformGroup(t);
		TransformGroup ptArr4 = new TransformGroup(t);
		TransformGroup ptArr5 = new TransformGroup(t);
		TransformGroup ptArr6 = new TransformGroup(t);
		...
		TransformGroup ptPos1 = new TransformGroup(t);
		TransformGroup ptPos2 = new TransformGroup(t);
		TransformGroup ptPos3 = new TransformGroup(t);
		TransformGroup ptPos4 = new TransformGroup(t);
		TransformGroup ptPos5 = new TransformGroup(t);
		TransformGroup ptPos6 = new TransformGroup(t);
		
		TransformGroup UDLPos1 = new TransformGroup(t);
		TransformGroup UDLPos2 = new TransformGroup(t);
		TransformGroup UDLPos3 = new TransformGroup(t);
		TransformGroup UDLPos4 = new TransformGroup(t);
		TransformGroup UDLPos5 = new TransformGroup(t);
		TransformGroup UDLPos6 = new TransformGroup(t);
		
		
		objSwitch = new Switch(Switch.CHILD_MASK);
        objSwitch.setCapability(Switch.ALLOW_SWITCH_WRITE);
		
        objSwitchUDL = new Switch(Switch.CHILD_MASK);
        objSwitchUDL.setCapability(Switch.ALLOW_SWITCH_WRITE);
		...
		objtrans.addChild(m_j3d.createText2D("SUPPORTED",new Vector3d(-0.35,0.18, 0.2),new Vector3d(0.6,0.6,0.6),new Color3f(0.1f,0.3f, 0.6f),16,Font.BOLD ));
		objtrans.addChild(m_j3d.createText2D("SUPPORTED",new Vector3d(0.2,0.18, 0.2),new Vector3d(0.6,0.6,0.6),new Color3f(0.1f,0.3f, 0.6f),16,Font.BOLD ));
		support1.addChild(m_j3d.createBox(new Vector3d(-0.2,-0.2f,0), new Vector3d(0.03,0.2f,0.03),new Vector3d(0,0,0),new Color3f(1f, 1f, 0.9f),"resources/images/grey13.jpg"));
		support2.addChild(m_j3d.createBox(new Vector3d(0.2,-0.2f,0), new Vector3d(0.03,0.2f,0.03),new Vector3d(0,0,0),new Color3f(1f, 1f, 0.9f),"resources/images/grey13.jpg"));

		beam1.addChild(createBeam(new Vector3d(0,0,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 0,0.44));
		beam2.addChild(createBeam(new Vector3d(0,-0.01,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 0.4,0.44));
		beam3.addChild(createBeam(new Vector3d(0,-0.02,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 0.8,0.44));
		beam4.addChild(createBeam(new Vector3d(0,-0.03,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 1.2,0.44));
		beam5.addChild(createBeam(new Vector3d(0,-0.04,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 1.6,0.44));
		beam6.addChild(createBeam(new Vector3d(0,-0.05,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 2.0,0.44));
		
		Ubeam1.addChild(createBeam(new Vector3d(0,0,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 0,0.44));
		Ubeam2.addChild(createBeam(new Vector3d(0,-0.01,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 0.4,0.44));
		Ubeam3.addChild(createBeam(new Vector3d(0,-0.02,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 0.8,0.44));
		Ubeam4.addChild(createBeam(new Vector3d(0,-0.03,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 1.2,0.44));
		Ubeam5.addChild(createBeam(new Vector3d(0,-0.04,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 1.6,0.44));
		Ubeam6.addChild(createBeam(new Vector3d(0,-0.05,0),new Vector3d(1,1,1),new Vector3d(0,0,0), 2.0,0.44));
		
		
		ptPos1.addChild(beam1);
		ptPos1.addChild(createArrow(new Vector3d(0,0.1,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		ptPos2.addChild(beam2);
		ptPos2.addChild(createArrow(new Vector3d(0,0.09,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		
		ptPos3.addChild(beam3);
		ptPos3.addChild(createArrow(new Vector3d(0,0.08,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		
		ptPos4.addChild(beam4);
		ptPos4.addChild(createArrow(new Vector3d(0,0.07,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		
		ptPos5.addChild(beam5);
		ptPos5.addChild(createArrow(new Vector3d(0,0.06,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		
		ptPos6.addChild(beam6);
		ptPos6.addChild(createArrow(new Vector3d(0,0.05,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		
		// ############################################# //
		UDLPos1.addChild(Ubeam1);
		UDLPos1.addChild(createArrow(new Vector3d(0,0.1,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos1.addChild(createArrow(new Vector3d(-0.1,0.1,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos1.addChild(createArrow(new Vector3d(0.1,0.1,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		
		UDLPos2.addChild(Ubeam2);
		UDLPos2.addChild(createArrow(new Vector3d(0,0.09,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos2.addChild(createArrow(new Vector3d(-0.1,0.09,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos2.addChild(createArrow(new Vector3d(0.1,0.09,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		
		UDLPos3.addChild(Ubeam3);
		UDLPos3.addChild(createArrow(new Vector3d(0,0.08,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos3.addChild(createArrow(new Vector3d(-0.1,0.08,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos3.addChild(createArrow(new Vector3d(0.1,0.08,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		
		UDLPos4.addChild(Ubeam4);
		UDLPos4.addChild(createArrow(new Vector3d(0,0.07,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos4.addChild(createArrow(new Vector3d(-0.1,0.07,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos4.addChild(createArrow(new Vector3d(0.1,0.07,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		
		UDLPos5.addChild(Ubeam5);
		UDLPos5.addChild(createArrow(new Vector3d(0,0.06,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos5.addChild(createArrow(new Vector3d(-0.1,0.06,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos5.addChild(createArrow(new Vector3d(0.1,0.06,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		
		UDLPos6.addChild(Ubeam6);
		UDLPos6.addChild(createArrow(new Vector3d(0,0.05,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos6.addChild(createArrow(new Vector3d(-0.1,0.05,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
		UDLPos6.addChild(createArrow(new Vector3d(0.1,0.05,0),new Vector3d(0.02,0.02,1), new Vector3d(0,0,180),new Color3f(0.1f,0.2f,0.3f)));
	 ...
	 */
	public Beams_Defelection1(Container container) {
	...
	public static class MyApplet extends JApplet {
		Beams_Defelection1 mainPanel;

		public void init() {
			setLayout(new BorderLayout());
			mainPanel = new Beams_Defelection1(this);
	...
	private static class MyFrame extends JFrame {
		MyFrame() {
			...
			getContentPane().add(new Beams_Defelection1(this),
					BorderLayout.CENTER);
			pack();
		}
	}
	...
	private void rightPanel() {
		...
		ImageIcon icon2 = m_j3d.createImageIcon("resources/SFD&BMD/1.jpg");
	...
	private void centerPanel(Container container) {
		...
		JLabel lbl = new JLabel("Analysis of Beams (Simply Supported)", JLabel.CENTER);
	...
	private void timerActionPerformed(java.awt.event.ActionEvent evt) {
		...
		java.util.BitSet mask2 = new java.util.BitSet(objSwitchUDL.numChildren());        
		objSwitchUDL.setChildMask(mask2);
		java.util.BitSet visibleNodes2 = new java.util.BitSet( objSwitchUDL.numChildren() );
		...
		{		
			...
			visibleNodes2.set(7);
			objSwitchUDL.setChildMask(visibleNodes2);
		}
		else
		{			
			visibleNodes1.set(7);

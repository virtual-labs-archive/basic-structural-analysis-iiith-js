...
public class PortalFrames extends javax.swing.JPanel {
	/**
	 * 
	 */
...
//		 Floor
   ...
   */
  public PortalFrames(Container container) {
...
//      scene.addChild(bgleg);
  ...
  public static class MyApplet extends JApplet {
      /**
		 ...
		 */
		private static final long serialVersionUID = 1L;
		PortalFrames mainPanel;

      public void init() {
          setLayout(new BorderLayout());
          mainPanel = new PortalFrames(this);
  ...
  private static class MyFrame extends JFrame {
      /**
		...
		MyFrame() {
          ...
          setTitle("Portal Frames Applet");
          getContentPane().add(new PortalFrames(this), BorderLayout.CENTER);
          pack();
      }
  }
...
////      rightBottom.setBackground(new Color(100,200,100));
  ...
  private void centerPanel(Container container){
       ...
       JLabel lbl = new JLabel("Portal Frames ", JLabel.CENTER);
...
//  }
  ...
  public int getStr() {
	...
	private void initInputControlsField() {
		...
		iLabel[i++].setForeground(Color.blue);// new JLabel(":PortalFrames (Hinge)",
												// JLabel.LEFT);
